...
import { productUpdating } from "../../store/action/product-Actions";
...
const UpdateProduct = ({ match, history }) => {
  ...
  const { isLoading, isUpdated } = useSelector((state) => state.products);
  ...
  const submitHandler = (e) => {
    ...
    dispatch(productUpdating(formData, product._id));
  };
