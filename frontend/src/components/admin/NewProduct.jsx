...
import { newProduct } from "../../store/action/product-Actions";
import { productDetailsActions } from "../../store/slice/productDetails-slice";
...
const NewProduct = ({ history }) => {
  ...
  const { isLoading, success } = useSelector((state) => state.details);
