...
import {
  getMyOrderDetails,
  updateOrder,
} from "../../store/action/order-actions";
...
const ProcessOrder = ({ match }) => {
  ...
  const { isLoading, order, isUpdated } = useSelector((state) => state.order);
  const {
    shippingInfo,
    orderItems,
    paymentInfo,
  ...
  }, [dispatch, alert, errorNotification, isUpdated, orderId, history]);
